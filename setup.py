"""
Create pii-data as a Python package
"""
...
from src.pii_data import VERSION

PKGNAME = "pii-data"
GITHUB_URL = "https://github.com/piisa/pii-data"
...
setup_args = dict(
    ...
    description="Base data structures for PII Processing",
    ...
    entry_points={
        "console_scripts": [
            "pii-data-raw = pii_data.app.rawdoc:main"
        ]
    },
